...
class Ui_VulnerabiliteInterface(object):
    def setupUi(self, VulnerabiliteInterface):
        ...
        VulnerabiliteInterface.resize(1033, 938)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/images/strike.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.vulnerabiliteliste = TreeWidget(self.reseauciblecard)
        self.vulnerabiliteliste.setMinimumSize(QtCore.QSize(700, 500))
        self.vulnerabiliteliste.setObjectName("vulnerabiliteliste")
        self.vulnerabiliteliste.headerItem().setText(0, "1")
        self.horizontalLayout_3.addWidget(self.vulnerabiliteliste)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/images/strikeicon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, VulnerabiliteInterface):
        ...
        self.StrongBodyLabel_2.setText(_translate("VulnerabiliteInterface", "Évaluer les vulnérabilités disponibles ou sélectionner celles qui sont pertinentes pour une recherche ciblée, selon les besoins"))
from qfluentwidgets import CardWidget, HorizontalSeparator, IconWidget, PrimaryPushButton, StrongBodyLabel, TitleLabel, TreeWidget
