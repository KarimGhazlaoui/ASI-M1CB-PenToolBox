...
class Ui_VulnerabiliteInterface(object):
    def setupUi(self, VulnerabiliteInterface):
        ...
        VulnerabiliteInterface.resize(1280, 800)
        VulnerabiliteInterface.setMinimumSize(QtCore.QSize(1280, 800))
        VulnerabiliteInterface.setMaximumSize(QtCore.QSize(1280, 800))
        ...
        self.vulnerabilitetable.setMinimumSize(QtCore.QSize(700, 400))
        self.vulnerabilitetable.setObjectName("vulnerabilitetable")
        self.vulnerabilitetable.setColumnCount(6)
        self.vulnerabilitetable.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.vulnerabilitetable.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.vulnerabilitetable.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.vulnerabilitetable.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.vulnerabilitetable.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.vulnerabilitetable.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.vulnerabilitetable.setHorizontalHeaderItem(5, item)
        self.vulnerabilitetable.horizontalHeader().setDefaultSectionSize(100)
        self.vulnerabilitetable.horizontalHeader().setStretchLastSection(True)
    ...
    def retranslateUi(self, VulnerabiliteInterface):
        ...
        item = self.vulnerabilitetable.horizontalHeaderItem(0)
        item.setText(_translate("VulnerabiliteInterface", "IP"))
        item = self.vulnerabilitetable.horizontalHeaderItem(1)
        item.setText(_translate("VulnerabiliteInterface", "PORT"))
        item = self.vulnerabilitetable.horizontalHeaderItem(2)
        item.setText(_translate("VulnerabiliteInterface", "PROTOCOLE"))
        item = self.vulnerabilitetable.horizontalHeaderItem(3)
        item.setText(_translate("VulnerabiliteInterface", "SEVERITE"))
        item = self.vulnerabilitetable.horizontalHeaderItem(4)
        item.setText(_translate("VulnerabiliteInterface", "NVT"))
        item = self.vulnerabilitetable.horizontalHeaderItem(5)
        item.setText(_translate("VulnerabiliteInterface", "CVE"))
