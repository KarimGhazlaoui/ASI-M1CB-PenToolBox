...
# Form implementation generated from reading ui file 'c:\GitHub\ASI-M1CB-PenToolBox-Interface\app\interface\ui\ScanInterface.ui'
#
...
class Ui_ScanInterface(object):
    def setupUi(self, ScanInterface):
        ...
        ScanInterface.resize(944, 523)
        ScanInterface.setMaximumSize(QtCore.QSize(1500, 800))
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(ScanInterface)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/images/scaninterfaceicon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.reseauciblecard.setMinimumSize(QtCore.QSize(376, 233))
        ...
        self.gridLayout_2.addWidget(self.reseauciblecard, 0, 1, 1, 1)
        self.CardWidget = CardWidget(ScanInterface)
        self.CardWidget.setMinimumSize(QtCore.QSize(398, 233))
        ...
        self.gridLayout_2.addWidget(self.CardWidget, 0, 2, 1, 1)
    ...
    def retranslateUi(self, ScanInterface):
        ...
        self.StrongBodyLabel.setText(_translate("ScanInterface", "Scans Automatisés"))
...
from qfluentwidgets import BodyLabel, CardWidget, CheckBox, HorizontalSeparator, IconWidget, LineEdit, PrimaryPushButton, StrongBodyLabel, TitleLabel
