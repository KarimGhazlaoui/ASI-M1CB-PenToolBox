...
class Ui_EvaluationInterface(object):
    ...
    def retranslateUi(self, EvaluationInterface):
        ...
        self.CaptionLabel.setText(_translate("EvaluationInterface", "Cible disponible :"))
...
from qfluentwidgets import CaptionLabel, CardWidget, ComboBox, IconWidget, PasswordLineEdit, PrimaryPushButton, StrongBodyLabel, TitleLabel, VerticalSeparator
