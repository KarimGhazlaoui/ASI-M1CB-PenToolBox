...
# Form implementation generated from reading ui file 'c:\GitHub\ASI-M1CB-PenToolBox-Interface\app\interface\ui\CibleInterface.ui'
#
...
class Ui_CibleInterface(object):
    def setupUi(self, CibleInterface):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/images/cible.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.cibledetecte.setMaximumSize(QtCore.QSize(700, 500))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/images/scanvulnerabilite.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.scanvulnerabilite.setIcon(icon2)
